...
#address = "0x523F0B41c24721b841D7dCfA5AEc29E7d62844c7"
################################################################################
# Step 1:
...
#st.sidebar.title("Crypto Wallet")
#account = generate_account()
#st.sidebar.write("Your account details:")
...
#balance = get_balance(w3, account.address) # Put this line 
#st.sidebar.write(f"Your current balance: {get_balance(w3, account.address)} ETH")
